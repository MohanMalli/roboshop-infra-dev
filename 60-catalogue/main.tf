...
#instance configuring #null resource
 ...
 provisioner "file" {
  source = "catalogue.sh"
  destination = "/tmp/catalogue.sh"  #copying file
 }
...
# stoping the instance depends on config
...
# deleting the instance after taking AMI ID
